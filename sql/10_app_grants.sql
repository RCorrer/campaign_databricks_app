-- Substitua o principal abaixo se necessário
...
GRANT SELECT, MODIFY ON TABLE main.campaign_app.campaign_header TO `54bb9d86-5e09-4386-a51a-30ac477e8155`;
GRANT SELECT, MODIFY ON TABLE main.campaign_app.campaign_briefing_version TO `54bb9d86-5e09-4386-a51a-30ac477e8155`;
GRANT SELECT, MODIFY ON TABLE main.campaign_app.campaign_segmentation_version TO `54bb9d86-5e09-4386-a51a-30ac477e8155`;
GRANT SELECT, MODIFY ON TABLE main.campaign_app.campaign_activation_version TO `54bb9d86-5e09-4386-a51a-30ac477e8155`;
GRANT SELECT, MODIFY ON TABLE main.campaign_app.campaign_status_history TO `54bb9d86-5e09-4386-a51a-30ac477e8155`;
GRANT SELECT, MODIFY ON TABLE main.campaign_app.campaign_audit_event TO `54bb9d86-5e09-4386-a51a-30ac477e8155`;
GRANT SELECT ON VIEW main.campaign_app.vw_campaign_current_definition TO `54bb9d86-5e09-4386-a51a-30ac477e8155`;
GRANT SELECT ON VIEW main.campaign_app.vw_campaign_dashboard TO `54bb9d86-5e09-4386-a51a-30ac477e8155`;
